			...
			switch ($section) {
				case 'information':
					...
					if ($this->form_validation->run()) {
						...
						if ($this->admins_model->update_row(array(
							'admin_id' => $this->view_data['active_admin']->admin_id
						), $admin_data)) {
							$this->session->set_flashdata('success', 'Your admin information successfully updated');
				...
				case 'password':
					...
					if ($this->form_validation->run()) {
						...
						if ($this->admins_model->update_row(array(
							...
							$this->session->set_flashdata('success', 'Your admin password successfully updated');
							redirect('profile/edit');
						}
					}
