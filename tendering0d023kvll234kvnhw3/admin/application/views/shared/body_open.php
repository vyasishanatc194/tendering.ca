			...
			<div class="d-flex align-items-center">
				...
				<a class="navbar-brand" href="<?= site_url(); ?>">
					<div class="d-flex align-items-center py-3">
						<img class="mr-2" src="<?= na_base_url('assets/img/illustrations/falcon.png'); ?>" alt=""
							 width="40"/>
						<span class="text-sans-serif">Admin Panel</span>
					</div>
				</a>
			</div>
				...
				<ul class="navbar-nav flex-column">
					...
					<li class="nav-item">
						<a class="nav-link" href="<?= site_url('admins') ?>">
							<div class="d-flex align-items-center">
								<span class="nav-link-icon"><span class="fas fa-user-md"></span></span>
								<span class="nav-link-text">
									Administrators
								</span>
							</div>
						...
						<a class="nav-link pr-0" id="navbarDropdownUser" href="#" role="button" data-toggle="dropdown"
						   aria-haspopup="true" aria-expanded="false">
							<div class="avatar avatar-xl">
								<img class="rounded-circle" src="<?= na_base_url('assets/img/team/3-thumb.png'); ?>"
									 alt=""/>
							</div>
						</a>
