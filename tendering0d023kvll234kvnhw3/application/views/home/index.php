	<section class="py-0 overflow-hidden" id="banner">
		...
		<div class="bg-holder overlay" style="background-image:url(<?= base_url('assets/img/generic/bg-1.jpg'); ?>);background-position: center bottom;">
		</div>
			...
			<div class="row justify-content-center align-items-center pt-8 pt-lg-10 pb-lg-9 pb-xl-0">
				<div class="col-md-11 col-lg-8 col-xl-4 pb-7 pb-xl-9 text-center text-xl-left">
					<h1 class="text-white font-weight-light">
						Bring <span class="typed-text font-weight-bold" data-typed-text='["design","beauty","elegance","perfection"]'></span>
						<br />
						to your webapp
					</h1>
					...
					<a class="btn btn-outline-light border-2x rounded-pill btn-lg mt-4 fs-0 py-2" href="<?= site_url('dashboard'); ?>">
						Start building with the falcon<span class="fas fa-play" data-fa-transform="shrink-6 down-1 right-5"></span>
					</a>
				</div>
				<div class="col-xl-7 offset-xl-1 align-self-end">
					<a class="img-landing-banner" href="<?= site_url('dashboard'); ?>">
						<img class="img-fluid d-dark-none" src="<?= site_url('assets/img/generic/dashboard-alt.png'); ?>" alt="" />
						<img class="img-fluid d-light-none" src="<?= site_url('assets/img/generic/dashboard-alt-dark.png'); ?>" alt="" />
					</a>
				</div>
			</div>
		</div>
	...
	<section>
		...
		<div class="bg-holder overlay" style="background-image:url(<?= base_url('assets/img/generic/bg-2.jpg'); ?>);background-position: center top;">
		</div>
		<div class="container">
			<div class="row justify-content-center text-center">
				<div class="col-lg-8">
					...
					<button class="btn btn-outline-light border-2x rounded-pill btn-lg mt-4 fs-0 py-2" type="button">Start your webapp</button>
				</div>
			</div>
		</div>
