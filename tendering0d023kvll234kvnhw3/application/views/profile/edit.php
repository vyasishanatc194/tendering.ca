			...
			<div class="form-row">
				<div class="form-group col-md-6">
					...
					<input type="text" class="form-control" name="first_name" id="first_name" required
						   value="<?= set_value('first_name') ? set_value('first_name') : $active_account->first_name; ?>">
				</div>
				<div class="form-group col-md-6">
					<label for="last_name">
					...
					<input type="text" class="form-control" name="last_name" id="last_name" required
						   value="<?= set_value('last_name') ? set_value('last_name') : $active_account->last_name; ?>">
				</div>
			</div>
			...
			<div class="form-row">
				<div class="form-group col">
					...
					<input type="email" class="form-control" name="email" id="email" required
						   value="<?= set_value('email') ? set_value('email') : $active_account->email; ?>">
				</div>
			</div>
