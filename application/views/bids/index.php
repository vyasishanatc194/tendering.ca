	...
	<div class="card-header">
		<div class="row align-items-center justify-content-between">
			...
			<div class="col-8 col-sm-auto text-right pl-2">
				<div class="d-none" id="bids-actions">
				...
				<tr>
					<th class="align-middle no-sort pr-3">
						<div class="custom-control custom-checkbox">
							<input class="custom-control-input checkbox-bulk-select" id="checkbox-bulk-bids-select"
								   type="checkbox" data-checkbox-body="#bids"
								   data-checkbox-actions="#bids-actions"
								   data-checkbox-replaced-element="#customer-table-actions"/>
							<label class="custom-control-label" for="checkbox-bulk-bids-select"></label>
						</div>
					</th>
								...
								<div class="dropdown text-sans-serif">
									...
									<div class="dropdown-menu dropdown-menu-right border py-0"
										...
										<div class="bg-white py-2">
											...
											<a class="dropdown-item"
											   href="<?= site_url('projects/documents/' . $project->project_id) ?>">
												Documents
											</a>
											<a class="dropdown-item"
